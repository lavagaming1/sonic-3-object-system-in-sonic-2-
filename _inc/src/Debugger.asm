...
; This should be the path to "Disassembler.asm":
  if EnableDebugger
	include "_inc/src/Disassembler.asm"
; ===========================================================================
...
MapEng_Debugger:	BINCLUDE	"_inc/src/DebuggerMap.bin"
	even
; ===========================================================================
...
HackerName:	vtstring WHITE,"Lavagaming  "
EMailmsg:	vtstring BLUE ,"lavagaming1@gmail.com         "
; ===========================================================================
